/**
 * @file
 * @brief Core clocking device in Raspberry PI 2/3
 *
...
#define BCM283X_SYSTEM_TIMER_BASE 0x3F003000
 ...
 */
#define BCM283X_SYSTEM_TIMER_MATCH_0 (1 << 0)
#define BCM283X_SYSTEM_TIMER_MATCH_1 (1 << 1)
#define BCM283X_SYSTEM_TIMER_MATCH_2 (1 << 2)
#define BCM283X_SYSTEM_TIMER_MATCH_3 (1 << 3)
...
static volatile struct raspi_timer_regs * const regs =
		(volatile struct raspi_timer_regs*)BCM283X_SYSTEM_TIMER_BASE;

static inline void raspi_systick_clear(void) {
	regs->CS = BCM283X_SYSTEM_TIMER_MATCH_3;
}
...
PERIPH_MEMORY_DEFINE(raspi_systick, BCM283X_SYSTEM_TIMER_BASE, sizeof(struct raspi_timer_regs));
