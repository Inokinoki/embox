 ...
 *
 * See BCM2836-ARM-Peripherals.pdf, 12 chapter for details.
 *
...
#define BCM2836_SYSTEM_TIMER_BASE 0x3F003000
...
static volatile struct raspi_timer_regs * const regs =
		(volatile struct raspi_timer_regs*)BCM2836_SYSTEM_TIMER_BASE;
...
PERIPH_MEMORY_DEFINE(raspi_systick, BCM2836_SYSTEM_TIMER_BASE, sizeof(struct raspi_timer_regs));
