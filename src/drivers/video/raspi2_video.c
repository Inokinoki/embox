...
static int raspi_init(void) {
	struct bcm2836_fb_info raspi_fb;
	struct fb_info *info;
	 ...
	 */
	bcm2836_mailbox_write(((uint32_t) &raspi_fb) + 0x40000000, BCM2836_FRAMEBUFFER_CHANNEL);
	if (bcm2836_mailbox_read(BCM2836_FRAMEBUFFER_CHANNEL) != 0 ||
